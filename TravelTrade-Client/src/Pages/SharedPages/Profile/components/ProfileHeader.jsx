      ...
      <div className="relative px-6">
        <div className="absolute -top-24 left-1/2 transform -translate-x-1/2">
          <div className="relative">
            <div className="w-40 h-40 rounded-full border-4 border-white shadow-xl overflow-hidden bg-gradient-to-br from-[#009ee2] to-[#00b4ff]">
              <img
                src={userData.photo}
                alt={userData.name}
            ...
            {userData.verificationStatus === "verified" && (
              <div className="absolute bottom-2 right-2 bg-green-500 text-white rounded-full p-1.5 border-2 border-white shadow-md">
                <FaCheck size={14} />
              </div>
            )}
          </div>
