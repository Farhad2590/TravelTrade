...
const Dashboard = () => {
  ...
  const userRole = isAdmin ? "admin" : isTraveler ? "traveler" : isSender ? "sender" : "unauthorized";

  // Links for Sender
  const senderLinks = [
    { name: "My Profile", path: "/dashboard/profile", icon: <FaUser /> },
    { name: "My Bids", path: "/dashboard/my-bids", icon: <FaBox /> },
    { name: "Find Travelers", path: "/dashboard/find-travelers", icon: <FaSearch /> },
    { name: "New Request", path: "/dashboard/new-request", icon: <FaBriefcase /> },
    { name: "Active Shipments", path: "/dashboard/active-shipments", icon: <FaExchangeAlt /> },
    { name: "Payment History", path: "/dashboard/payments", icon: <FaFileInvoiceDollar /> },
  ...
  const travelerLinks = [
    ...
    { name: "My Trip Schedule", path: "/dashboard/my-trips", icon: <FaMapMarkedAlt /> },
    { name: "Available Requests", path: "/dashboard/available-requests", icon: <FaShoppingCart /> },
    { name: "Current Deliveries", path: "/dashboard/current-deliveries", icon: <FaBox /> },
    { name: "Earnings", path: "/dashboard/earnings", icon: <FaMoneyBillWave /> },
    { name: "Received Reviews", path: "/dashboard/received-reviews", icon: <FaStar /> },
  ];

  // Links for Admin
  const adminLinks = [
    { name: "Admin Profile", path: "/dashboard/profile", icon: <FaUser /> },
    { name: "User Management", path: "/dashboard/manage-users", icon: <FaUsersCog /> },
